...
class Packer():
    ap = nst_messages.ap_status_v7()
    act = nst_messages.actuator_v3()
    airdata = nst_messages.airdata_v8()
    nav = nst_messages.nav_v6()
    nav_metrics = nst_messages.nav_metrics_v6()
    gps = nst_messages.gps_v5()
    health = nst_messages.system_health_v6()
    imu = nst_messages.imu_v6()
    incep = nst_messages.inceptors_v1()
    pilot = nst_messages.pilot_v3()
    ap_buf = None
    act_buf = None
    airdata_buf = None
    nav_buf = None
    ...
    def unpack_airdata_v6(self, buf):
        air = nst_messages.airdata_v6(buf)
    ...
    def unpack_airdata_v7(self, buf):
        air = nst_messages.airdata_v7(buf)
    ...
    def unpack_airdata_v8(self, buf):
        air = nst_messages.airdata_v8(buf)
        if air.index > 0:
            print("Warning: airdata index > 0 not supported")
    ...
    def unpack_filter_v4(self, buf):
        nav = nst_messages.filter_v4(buf)
    ...
    def unpack_filter_v5(self, buf):
        nav = nst_messages.filter_v5(buf)
    ...
    def unpack_nav_metrics_v6(self, buf):
        metrics = nst_messages.nav_metrics_v6(buf)
        if metrics.index > 0:
    ...
    def unpack_act_v2(self, buf):
        act = nst_messages.actuator_v2(buf)
    ...
    def unpack_act_v3(self, buf):
        act = nst_messages.actuator_v3(buf)
        act_node.setDouble("timestamp", act.timestamp_sec)
        act_node.setDouble("aileron", act.aileron)
        act_node.setDouble("elevator", act.elevator)
        act_node.setDouble("throttle", act.throttle)
    ...
    def unpack_effectors_v1(self, buf):
        eff = nst_messages.effectors_v1(buf)
    ...
    def unpack_inceptors_v1(self, buf):
        incep = nst_messages.inceptors_v1(buf)
        if incep.index > 0:
    ...
    def unpack_pilot_v2(self, buf):
        pilot = nst_messages.pilot_v2(buf)
    ...
    def unpack_pilot_v3(self, buf):
        pilot = nst_messages.pilot_v3(buf)
    ...
    def unpack_pilot_v4(self, buf):
        pilot = nst_messages.pilot_v4(buf)
        if pilot.index > 0:
            print("Warning: pilot index > 0 not supported")
    ...
    def unpack_power_v1(self, buf):
        power = nst_messages.power_v1(buf)
        if power.index > 0:
    ...
    def unpack_ap_status_v6(self, buf):
        ap = nst_messages.ap_status_v6(buf)
    ...
    def unpack_ap_status_v7(self, buf):
        ap = nst_messages.ap_status_v7(buf)
    ...
    def unpack_ap_targets_v1(self, buf):
        ap = nst_messages.ap_targets_v1(buf)
        ap.msg2props(targets_node)
        return 0

    def unpack_mission_v1(self, buf):
        mission = nst_messages.mission_v1(buf)
    ...
    def unpack_system_health_v4(self, buf):
        health = nst_messages.system_health_v4(buf)
    ...
    def unpack_system_health_v5(self, buf):
        health = nst_messages.system_health_v5(buf)
        status_node.setDouble("frame_time", health.timestamp_sec)
        status_node.setDouble("system_load_avg", health.system_load_avg)
        power_node.setDouble("avionics_vcc", health.avionics_vcc)
        power_node.setDouble("main_vcc", health.main_vcc)
    ...
    def unpack_system_health_v6(self, buf):
        health = nst_messages.system_health_v6(buf)
        status_node.setDouble("frame_time", health.timestamp_sec)
        status_node.setDouble("system_load_avg", health.system_load_avg)
    ...
    def unpack_status_v7(self, buf):
        status = nst_messages.status_v7(buf)
        if status.index > 0:
    ...
    def unpack_payload_v2(self, buf):
        payload = nst_messages.payload_v2(buf)
    ...
    def unpack_payload_v3(self, buf):
        payload = nst_messages.payload_v3(buf)
        payload_node.setDouble("timestamp", payload.timestamp_sec)
        payload_node.setInt("trigger_num", payload.trigger_num)
        return payload.index
    ...
    def unpack_event_v1(self, buf):
        event = nst_messages.event_v1(buf)
    ...
    def unpack_event_v2(self, buf):
        event = nst_messages.event_v2(buf)
